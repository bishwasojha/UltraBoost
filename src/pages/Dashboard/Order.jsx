          ...
          <div className="order-content">
            <div className="order-chat">
                <div className="chat-content">
                    ...
                    <p className='our-chat'>Thanks for purchasing division boosting, please send us your username and password, so I can start boosting. Please disable two factor authentication.</p>
                    <p className='user-reply'>Username: bonop003 
                    Password:3048234xyz!@#</p>
                </div>
